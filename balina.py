...
def ana_uygulama():
    ...
    if menu == "💼 CÜZDAN":
        ...
        if "portfoy" in db[user] and db[user]["portfoy"]:
            ...
            with c_pie:
                if pie_data:
                    fig_pie = px.pie(pd.DataFrame(pie_data), values='Deger', names='Sembol', hole=0.4)
                ...
                try:
                    ...
                    if len(df) > 10:
                        ...
                        if durum:
                            ...
                            bulunanlar.append({"Sembol": isim, "Fiyat": fiyat, "Sinyal": durum, "Renk": renk, "Kod": symbol})
