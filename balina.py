...
# --- TASARIM (NEON CYBERPUNK + YASAL UYARI CSS) ---
st.markdown("""
    <style>
...
def render_footer():
    st.markdown("""<div class="footer">© 2025 PALA BALİNA AVCISI | LİSANSLI YAZILIMDIR | v4.0 | TÜM HAKLARI SAKLIDIR</div>""", unsafe_allow_html=True)
...
def login_page():
    ...
    with col_login:
        ...
        <div class="disclaimer-box">
            <span class="disclaimer-title">⚠️ YASAL UYARI</span>
